      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col items-center gap-8 rounded-[28px] bg-[#2A4E6E] px-6 py-10 text-center sm:flex-row sm:justify-between sm:px-12 sm:py-12 sm:text-left">
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:gap-8">
            <ProductArt icon={<BuildingIcon className="h-full w-full" />} tone="white" size="sm" />
            <div>
          ...
          <a
            ...
            className="inline-flex shrink-0 items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-[#2A4E6E] transition-colors hover:bg-white/90"
          >
            {commercial.cta}
